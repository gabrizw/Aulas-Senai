            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sw">
                    <div class="card-header py-3">
                        ...
                        </svg>&nbsp;&nbsp;<font style="font-size: 30px;"><b>Resultado</b></font>
                    </div>
                    <div class="card-body">
                        <?php
                            $n1 = $_POST['n1'];
                            ...
                            if($media >= 70){
                                echo "<br/> O aluno passou pois sua media é de <b>$media</b><br/>";
                                echo "<br/><a href='index.php' class='btn btn-outline-success' tabindex='-1' role='button'>VOLTAR</a>";
                            }
                            else if($media <70){
                                echo "<br/> O aluno reprovou pois sua media é de <b>$media</b><br/>";
                                echo "<br/><a href='index.php' class='btn btn-outline-success' tabindex='-1' role='button'>VOLTAR</a>";
                            }
